...
lint.markdown-links:
	@$(DOCKERCMD) run --rm -v "$$PWD:/workspace" -w /workspace -e GITHUB_TOKEN ghcr.io/jhoblitt/markdown-linkerator:v0 --config tests/scripts/mlc_config.json Documentation
